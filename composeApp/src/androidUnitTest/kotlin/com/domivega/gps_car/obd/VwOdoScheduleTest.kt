...
class VwOdoScheduleTest {
    ...
    fun `markLocked stops all further hops until reset`() {
        // Reaching a cluster DID means switching the ELM away from engine addressing,
        // which breaks Mode 01. Once the odometer baseline is captured, PID 0x31
        // carries it and no further hop is worth that cost.
        val s = sched(engineOkMin = 1)
